...
module.exports = calc; // export { calc };
...
function form() {
  ...
  form.addEventListener('submit', function (event) {
    ...
    var formData = new FormData(form); // request.send(formData); // переменная formData местит в себе данные в формате ключ-значение, просто отправляем ее
...
module.exports = form; // export { form };
...
module.exports = modal; // export { modal };
...
module.exports = slider; // export { slider };
...
module.exports = tabs; // export { tabs };
...
module.exports = timer; // export { timer };
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var calc = __webpack_require__(/*! ./modules/calc */ "./src/js/modules/calc.js"),
  ...
  slider();
  tabs();
  timer(); // let calc = import {calc} from './modules/calc';
